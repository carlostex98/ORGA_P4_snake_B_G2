...
namespace Snake
{
    public partial class TopTiempo : Form
    {
        public TopTiempo()
        {
            InitializeComponent();
        ...
        private void TopTiempo_Load(object sender, EventArgs e)
        {
            
        }

        private void TopTiempo_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
